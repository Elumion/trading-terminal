import { port } from './cors';

export const globalConfig = {
    proxy: `http://localhost:${port}/`, // insert proxy link for cors
    exchanges: [
        // insert new obj with exchange to have opportunity to create new valid exchange
        {
            ccxtName: 'binance',
            name: 'Binance',
